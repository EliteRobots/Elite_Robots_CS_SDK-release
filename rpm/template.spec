...
%global pkg_name elite_cs_series_sdk
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-humble-elite-cs-series-sdk
Version:        1.5.0
Release:        2%{?dist}
Summary:        ROS %{pkg_name} package

License:        MIT
URL:            https://www.eliterobots.com/
...
%description
Elite Robots CS Series SDK (C++ library for Elibot CS series robotic arms).
...
%changelog
* Fri Aug 28 2026 Elite Robots <dukang@elibot.cn> - 1.5.0-2
- Autogenerated by Bloom

* Fri Aug 28 2026 Elite Robots <dukang@elibot.cn> - 1.5.0-1
- Autogenerated by Bloom

* Mon Jul 27 2026 Elite Robots <dukang@elibot.cn> - 1.4.7-1
- Autogenerated by Bloom
